  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="font-mono text-[11px] tracking-[0.14em] text-text-secondary">COMPANY PROFILE</p>
      ...
      <p className="max-w-2xl font-mono text-xs text-text-secondary">{companyProfile.meetingCaption}</p>

      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {companyProfile.sections.map((section) =>
          section.title === 'Productivity benchmark' ? (
            <section key={section.title} className="rounded-xl border border-border-subtle bg-bg-panel p-5 sm:p-7">
              ...
              <div className="mt-3 flex items-baseline gap-2">
                ...
                <span className="font-mono text-xs text-text-secondary">/ employee / day</span>
              </div>
